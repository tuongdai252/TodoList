<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditTask.aspx.cs" Inherits="TodoList3Layers.GUI.EditTask" %>
        ...
        <div class="col-md-6">
            <div class="row" style="padding-top: 20px;">
                <div class="col-md text-center header text-uppercase">
                    <h3 style="font-weight: bolder; color: white;">Sửa công việc</h3>
                </div>
            </div>
            <div class="body">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <asp:DropDownList CssClass="input-form" ID="chooseStatus" runat="server">
                            <asp:ListItem Text="Hoàn thành" Value="Hoàn thành"></asp:ListItem>
                            <asp:ListItem Text="Đang làm" Value="Đang làm"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 list-checkbox">
                        <asp:CheckBoxList ID="choosePartners" runat="server" OnSelectedIndexChanged="btnEditTask_Click" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:FileUpload CssClass="file-upload" AllowMultiple="true" ID="FileUploadTask" Width="250px" runat="server" />
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md text-center">
                        <asp:Button CssClass="btn btn-success rounded-sm" ID="btnEditTask" runat="server" Text="Cập nhật" OnClick="btnEditTask_Click" />
                    </div>
                </div>
